...
## 9. Ngoài phạm vi MVP (YAGNI)

Cố tình loại trừ để giai đoạn sau:
- Định danh người chơi game.
- Đa nhà cung cấp eKYC.
- Tách microservices (Hướng B) / hàng đợi bất đồng bộ (Hướng C).
- Social login.

Ranh giới module được thiết kế sẵn để tiến hóa lên các hướng này mà không phải viết lại.
